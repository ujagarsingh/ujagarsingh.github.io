...
किसी भी Program का ये Default Behavior होता है ।

लेकिन जब कोई Calling Method जिस Method को Call करता है, उस Method के पूरी तरह से Completely Execute होने का Wait नहीं करता,  बल्कि Method को Call करके अपने स्वयं के अगले Codes को Process करने लगता है, तो इस प्रकार के Program को Asynchronous Program कहते हैं और इस तरह का Method, जिसके Complete होने के लिए Calling Method Wait नहीं करता,  `Asynchronous Method` कहलाता है।
...
सीधे शब्दों में कहे तो, जिस component (जैसे की :- input element) की value, `Class Component` की  state से control होती है। वह component "control component" कहलाता है।
...
--- 
#### निष्कर्ष (Conclusion)
जैसा कि मैंने पहले भी बताया था की, React Component में  `re-usable code` एक शानदार तरीका है। हमें केवल  एक Class बनानी होती है और फिर जहां चाहें, उसके instance ( उदाहरण ) को call कर सकते हैं। फिर भी, कुछ मामले हैं जहाँ  developers बेहतर विकल्प को तलाश सकते हैं। इनमें से कुछ मामले हैं:

1. **यदि पूरी तरह से code आपका  नहीं हो** - Developers शायद ही कभी अकेले काम करते हों। वे समूहों में काम करते हैं, और GitHub और Bit जैसे platforms पर अपने code को  share करते हैं। तो, ऐसे मैं  re-usable component जिसे developer अपने app में use कर रहे हैं, और जो की शायद स्वयं द्वारा नहीं लिखा जा सकता या लिखना बहुत कठिन है। तो आपको उसमें changes नहीं करने चाहिए ।
2. **कहीं चाहें और कहीं नहीं** - यदि आप अलग-अलग जगह अलग-अलग तरीके से component का use करना चाहें । 
