...
HTML में, '<input>', '<textarea>', और '<select>' जैसे तत्व आमतौर पर अपनी स्थिति बनाए रखते हैं और इसे उपयोगकर्ता इनपुट के आधार पर update करते हैं। प्रतिक्रिया में, उत्परिवर्तनीय स्थिति को आमतौर पर componentों की state संपत्ति में रखा जाता है, और केवल setState() के साथ update किया जाता है।
